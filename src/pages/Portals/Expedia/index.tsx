...
interface ExpediaPortalProps {
  resetForm: () => void;
  onOpenChange: (open: boolean) => void;
}

const ExpediaPortal: React.FC<ExpediaPortalProps> = ({
  resetForm,
  onOpenChange,
}) => {
  return (
    <div>
      <div className="flex justify-between items-center mb-10">
        <h2 className="text-[20px] text-black font-semibold">Add Expedia</h2>
        <IconX
          color="red"
